...
SUDOERS_LINE='Defaults env_keep += "FINGERKEY_REASON"'
...
# wire_sudoers drops a sudoers.d snippet so the FINGERKEY_REASON env var
...
echo "  sudoers:  ${SUDOERS_DROPIN} -> ${SUDOERS_LINE}"
